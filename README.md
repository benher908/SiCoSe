...
Si necesitas levantar solo los servicios base del entorno de desarrollo,
puedes usar Docker Compose sin instalar PostgreSQL ni Redis de forma local.
...
Las variables de desarrollo para los contenedores estan en
`.env.docker`.
